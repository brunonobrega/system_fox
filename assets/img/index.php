...
<head>
  ...
  <body>
			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner">
				<div class="item active">
				  <img src="assets/img/carousel_blue.png" alt="Imagem 1">
				</div>
				<div class="item">
				  <img src="assets/img/carousel_green.png" alt="Imagem 2">
				</div>
				<div class="item">
				  <img src="assets/img/carousel_red.png" alt="Imagem 3">
				</div>
			  </div>
	...
	<blockquote>
	  ...
	  Você só é você mesmo, a partir do momento que você é você mesmo.
	  </p>
	  <footer style="padding-left:5.7em;">– Bruno Nobrega em <cite title="">Suas grandes aventuras</cite></footer>
	</blockquote>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				<div class="equipe">
					<img src="assets/img/mockup.png" class="img-circle" alt="" width="170" />
					<h3>Alan Kerlis</h3>
